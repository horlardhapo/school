                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('student/update',$data->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label text-md-right">Student Info</label>

                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $data->name }}" required autofocus>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="roll" type="text" class="form-control{{ $errors->has('roll') ? ' is-invalid' : '' }}" name="roll" value="{{ $data->roll }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="reg_id" type="text" class="form-control{{ $errors->has('reg_id') ? ' is-invalid' : '' }}" name="reg_id" value="{{ $data->reg_id }}" readonly="" required autofocus>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="classes_id" class="col-sm-4 col-form-label text-md-right">Class: </label>
